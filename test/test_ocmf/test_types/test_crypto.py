"""Tests for crypto enum types and their composition methods."""
...
class TestKeyType:
    """Test suite for KeyType enum."""

    def test_from_curve(self) -> None:
        """Test constructing KeyType from CurveType."""
    ...
    def test_curve_property(self) -> None:
        """Test extracting CurveType from KeyType."""
    ...
    def test_roundtrip(self) -> None:
        """Test that from_curve and curve property are inverses."""
...
class TestSignatureMethod:
    """Test suite for SignatureMethod enum."""

    def test_from_parts(self) -> None:
        """Test constructing SignatureMethod from CurveType and HashAlgorithm."""
        assert (
    ...
    def test_curve_property(self) -> None:
        """Test extracting CurveType from SignatureMethod."""
    ...
    def test_hash_algorithm_property(self) -> None:
        """Test extracting HashAlgorithm from SignatureMethod."""
    ...
    def test_roundtrip(self) -> None:
        """Test that from_parts and properties are inverses."""
    ...
    def test_from_parts_invalid_combination(self) -> None:
        """Test that invalid curve/hash combinations raise ValueError."""
